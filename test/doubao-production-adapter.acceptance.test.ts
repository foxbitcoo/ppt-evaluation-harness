...
test("the exact-current public Doubao replay fixture records durable recovery and retained render warnings", () => {
  ...
  assert.deepEqual(
    ...
    },
    {
      ...
      specCommitSha:
        "8cf4f7aa457da49b7e3ba96d2c57d412f0447eb5",
      sourceArchiveDigest:
  ...
  assert.equal(
    ...
    "sha256:8a03fb2e2a8ac37db4b8d37d424d9c8ab86b09f3d9015d74ef9af54adaee21ce",
  );
  ...
  assert.equal(
    ...
    "sha256:5c491693d4f9eb3ea7d2ae8ea6c943ee36bd1d6b755b09c1f488a24a31039256",
  );
  assert.equal(
